...
import { Member } from 'apps/rent-housing-api/src/libs/dto/member/member';
import { Property } from 'apps/rent-housing-api/src/libs/dto/property/property';
import { MemberStatus, MemberType } from 'apps/rent-housing-api/src/libs/enums/member.enum';
import { PropertyStatus } from 'apps/rent-housing-api/src/libs/enums/property.enum';
...
export class RentHousingBatchService {
	...
	public async batchRollback(): Promise<void> {
		...
		await this.memberModel.updateMany({ memberStatus: MemberStatus.ACTIVE }, { memberRank: 0 }).exec();
	}
